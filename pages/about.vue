<template>
    <div class="page-body">
        ...
        <section class="about-section">
            <h2>About Us</h2>
            <p>Welcome to Gebeya, your ultimate destination for all your shopping needs. At Shopiverse, we strive to provide you with a seamless and enjoyable shopping experience, offering a wide range of products from various categories.</p>
